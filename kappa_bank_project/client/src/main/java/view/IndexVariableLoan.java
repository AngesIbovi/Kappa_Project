...
/*
	 ...
	 * @author user
	 */
	public class IndexVariableLoan extends javax.swing.JFrame {

	    /**
	     * Creates new form index1
	     */
	    public IndexVariableLoan() {
	        initComponents();
	    }
	    ...
	    private void initComponents() {
	        ...
	        // This decription it's for add a arraylist of account number
	         ...
	         listnumber = communication.getAllAcounts();
	         arrayOftypeLoan=communication.getAlltypeofLoan();
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(IndexVariableLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new IndexVariableLoan().setVisible(true);
	            }
	        });
	    }
