...
import elements.AmortizationElement;
import elements.MainVolumesElement;
import elements.SimulationComparisonElement;
import elements.SimulationListElement;
...
public abstract class SimulationComparisonGUI extends JPanel implements SessionSpecific {
	...
	public static void main(String[] args) {
		...
		gui.simulations.add(JsonImpl.fromJson("{\"name\":\"Simu achat maison 3 - �ch�ances constantes\",\"id\":\"5\",\"events\":[],\"repayments\":[],\"effectiveDate\":\"ao�t 28, 2016\",\"capital\":28000.0,\"remainingOwedCapital\":28000.0,\"repaymentFrequency\":12,\"remainingRepayments\":132,\"repaymentConstant\":267.0,\"amortizationType\":\"steady\",\"loan_type_id\":\"2\",\"account_id\":\"3\"}", GetSimServerResponse.class));
