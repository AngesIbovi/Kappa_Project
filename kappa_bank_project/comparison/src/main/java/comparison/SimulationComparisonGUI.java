...
import comparison.elements.RepaymentComparisonElement;
...
public abstract class SimulationComparisonGUI extends JPanel implements SessionSpecific {
	...
	private final SimulationListElement simulationListElement;
	...
	public SimulationComparisonGUI() {
		...
		// Elements
		simulationListElement = new SimulationListElement();
		elements.add(simulationListElement);
		...
		RepaymentComparisonElement repayments = new RepaymentComparisonElement();
		elements.add(repayments);
	...
	public void setSessionInformation(SessionInformation sessionInformation) {
		...
		simulationListElement.setSessionInformation(sessionInformation);
	}
