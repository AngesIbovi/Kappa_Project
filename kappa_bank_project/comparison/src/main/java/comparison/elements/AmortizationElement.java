...
public class AmortizationElement extends SimulationComparisonElement {
	...
	private class Row {
		...
		public Row(Simulation sim) {
			...
			case degressive:
				this.amortizationType = "Dégressives";
				break;
			case steady:
			...
			totalDuration = totalYears + " années, et " + totalMonths + " mois";
	...
	public void setSimulations(List<Simulation> simulations) {
		...
		AbstractTableModel tableModel = new AbstractTableModel() {
			private final String[] headers = {"Nom de la simulation", "Type de mensualités", "Durée du prêt", 
					"Première mensualité", "Dernière mensualité", "Nombre de mensualités par an", "Nombre de mensualités total"};
