...
public class Main {
	...
	public void DisplayMenu() throws IOException {
		System.out.println("------------------------Bienvenue � la banque mutuelle -----------------------------");
		System.out.println();
		...
		case 1:
			...
			if (reponseautentification == "OK") {
				System.out
						.println("-----------------------------Vous êtes connecter :" + login + "------------------------");
				System.out.println();
				...
				System.out.println("tapez 3	consulter les intérêts perdus  j'usqu'a une date");
